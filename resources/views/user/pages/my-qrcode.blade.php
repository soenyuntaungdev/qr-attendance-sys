...
<div class="container mt-4 mb-5">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body p-4 text-center">
                    ...
                    <p class="text-muted mb-3">
                        <span class="badge bg-info me-2">{{ ucfirst($user->userType->name ?? 'N/A') }}</span>
                    ...
                    @if ($user->qr_code_path)
                        ...
                        <img id="qr-image" src="{{ asset('storage/' . $user->qr_code_path) }}" 
                             alt="My QR Code" width="250" height="250" />
                        ...
                        <div class="d-grid gap-2 col-md-6 mx-auto">
                            <a href="{{ route('user.download.qr', $user->id) }}" class="btn btn-primary">
    ...
    <div class="card-body">
        @if($attendanceLogs->isEmpty())
            <p class="text-muted">No gat pass records found.</p>
        @else
