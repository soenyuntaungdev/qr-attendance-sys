                ...
                <div class="card h-100 border-0 shadow-lg neon-card">
                    <div class="card-body d-flex flex-column justify-content-center text-center text-md-start">
                        ...
                        <p class="card-text mb-4">
                            Modern solution to track gate pass records for students, teachers, staff, and visitors with permanent and temporary QR codes.
                        </p>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 mb-5" id="features">
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-lg neon-card text-center p-3">
                    ...
                    <p class="card-text">Monitor gate pass instantly via our responsive dashboard.</p>
                </div>
            </div>
            <div class="col">
                <div class="card h-100 border-0 shadow-lg neon-card text-center p-3">
                    ...
                    <p class="card-text">Generate detailed reports for gate pass records.</p>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <div>
                            ...
                            <p>Scan at entry/exit points for automatic gate pass recording.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
